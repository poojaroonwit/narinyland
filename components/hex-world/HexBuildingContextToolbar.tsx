...
export function HexBuildingContextToolbar({ removable, busy, onMove, onRotate, onRemove, onClose }: {
  ...
  return (
    <div className="pointer-events-auto fixed right-3 top-[6.2rem] z-[93] flex flex-col gap-1.5 rounded-2xl border border-white/80 bg-white/90 p-1.5 shadow-xl shadow-stone-950/[0.08] backdrop-blur-xl md:right-5 md:top-[6.7rem]">
